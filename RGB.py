...
try:
    ...
    while RUNNING:
        ...
        #For anode RGB LED users, if you want to start with RED too the only
        # thing to be done is defining RED as one and GREEN and BLUE as 100.
        for x in range(1,101):
            ...
            #and for delay time.sleep is used. You can chance the duration
            #of the colors with changing the time from here
            time.sleep(0.05)
    ...
    #it will stop the while loop and turn off the pins,
    #which means your LED won't light anymore
    RUNNING = False
    GPIO.cleanup()
